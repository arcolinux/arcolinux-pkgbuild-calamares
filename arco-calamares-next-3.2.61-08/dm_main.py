...
desktop_environments = [
    ...
    DesktopEnvironment('/usr/bin/io.elementary.wingpanel', 'pantheon'),
    DesktopEnvironment('/usr/bin/gnome-session', 'gnome-xorg'),
    ...
    DesktopEnvironment('/usr/bin/worm', 'berry'),
]
...
class DMsddm(DisplayManager):
    ...
    def set_autologin(self, username, do_autologin, default_desktop_environment):
        ...
        sddm_conf_path = os.path.join(self.root_mount_point, "etc/sddm.conf.d/kde_settings.conf")
